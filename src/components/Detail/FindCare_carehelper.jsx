...
import CareMore_carehelper from "./CareMore_carehelper";

const FindCare_carehelper = () => {
          ...
          {cards.map((card) => (
            <div key={card.id} className="p-2">
              ...
              {selectedCard === card.id ? (
                ...
                <CareMore_carehelper onClose={handleExpandClose} selectedCard={selectedCard} />
                </div>
              ) : (
...
export default FindCare_carehelper;
