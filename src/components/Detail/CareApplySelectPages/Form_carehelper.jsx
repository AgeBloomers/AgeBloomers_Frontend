          ...
          {/* 유형 */}
            ...
            <div className="m-[10px] sm:m-[20px] mx-7 sm:mx-10 flex items-center"> 나이
              <input
                type="number"
                name="age"
                className="border border-gray-300 rounded-lg ml-5 p-2 w-10 sm:w-20 text-[13px] sm:text-sm"
                placeholder=""
                onChange={handleAgeChange}
              />
              <div className="ml-2">세</div>
              <div className="ml-1 sm:ml-2 text-ef4444 text-[13px] sm:text-[15px]">
              * 보호자님은 어르신 정보를 입력해 주세요
              </div>
            </div>
            <div className="border-t m-[25px] mx-10"></div>
