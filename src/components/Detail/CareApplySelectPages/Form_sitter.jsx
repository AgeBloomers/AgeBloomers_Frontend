...
const Form_sitter = () => {
  ...
  return (
        ...
        <NavBar />
        <div className="top-[130px] sm:pt-[20px] min-w-full sm:min-h-[1200px] flex justify-center relative bg-neutral-100 text-5C5C5C font-bold text-[15px] sm:text-[16px]">
        <div className="flex justify-center items-center w-full mx-4 sm:mx-0">
          <div className="bg-white rounded-3xl w-full sm:w-[600px] h-auto sm:h-[1050px]">
          ...
          {!formValid && (
            <p className="ml-20 text-ef4444 text-left font-Pretendard">
              ...
              {/* 나이 */}
              <div className="m-[25px] ml-10 flex items-center"> 나이
                <input
                  type="number"
                  name="age"
            ...
            {/* 지역 */}    
              <div className="m-[25px] ml-10 flex items-center"> 지역
                <select
            ...
            {/* 연락처 */}
              <div className="m-[25px] ml-10"> 연락처
                <input
                  type="number"
                  name="contact"
                  className="border border-gray-300 rounded-lg ml-7 p-2 w-96"
            ...
            {/* 이메일 */}
              <div className="m-[25px] ml-10"> 이메일
                <input
                  type="email"
                  name="email"
                  className="border border-gray-300 rounded-lg ml-7 p-2 w-96"
              ...
              {/* 희망 날짜 */}
              <div className="m-[25px] ml-10 flex"> 희망 날짜
                <DatePicker
                ...
                />
                  ...
                  <div className="border-t m-[25px] mx-10"></div>
              {/* 코멘트 */}
              <div className="m-[25px] ml-10"> 코멘트
                <input
                  type="text"
                  name="comment"
                  className="border border-gray-300 rounded-lg ml-7 p-2 w-96"
