...
const FindMore = ({ onClose, selectedCard }) => {
  // 카드 데이터 배열
  const cardData = [
    {
      id: 1,
    ...
    },
    {
      ...
      },
      {
        ...
        time: "희망 시간 : 09:00 ~ 17:00",
        coment: "코멘트 : 도시락 지참해주세요. 저는 따로 밥을 차려드리지 않습니다",
      },
      {
        id: 6,
        title: "이름 : 루스",
