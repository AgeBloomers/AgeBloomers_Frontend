...
import FindMore_Parent from "./FindMore_Parent";

const FindSitter_Parent = () => {
          ...
          {cards.map((card) => (
            <div key={card.id} className="p-2">
              ...
              {selectedCard === card.id ? (
                ...
                <FindMore_Parent onClose={handleExpandClose} selectedCard={selectedCard} />
                </div>
              ) : (
...
export default FindSitter_Parent;
